...
@section('title', '顧客マスタ管理 編集')

@section('content_header')
<div class="row">
    <div class="col-sm-6">
        <h1 class="m-0">顧客マスタ管理<small>編集</small></h1>
    </div>
</div>
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            {!! Form::open(['method' => 'PUT', 'url' => route('customer.update', $customer->id)]) !!}
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="text-center">
                    <a class="btn btn-default mr-3" href="{{ route('customer.detail', $customer->id) }}">
                        <i class="fas fa-angle-left"></i> 詳細へ戻る
                    </a>
